...
function start_kasmvnc (){
    ...
    /usr/bin/vncserver :$DESKTOP_NUMBER -depth 24 -geometry 1280x1050 -websocketPort $BASE_PORT -cert ${HOME}/.vnc/self.pem -httpd /usr/share/kasmvnc/www -disableBasicAuth -FrameRate=24 -interface 0.0.0.0
    echo "HEREDONE"
